...
docker compose --file docker-compose-invoke.yml --profile download up --build -d

echo "------build and run download end"
# wait until its done, then:
#docker compose --profile [ui] up --build
#docker compose --profile auto up --build
docker compose --file docker-compose-invoke.yml --profile invoke up --build -d
#docker compose --profile auto up --build -d --force-recreate
# where [ui] is one of: invoke | auto | auto-cpu | comfy | comfy-cpu
echo "------build and run invoke end"
